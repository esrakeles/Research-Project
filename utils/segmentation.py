...
def segment_characters_from_plate(plate_img, fixed_width):
    ...
    labels = measure.label(thresh, background=0, return_num=False, connectivity=2)
    ...
    for label in np.unique(labels):
        ...
        if label == 0:
            continue
        # geçerli etiket için yalnızca bağlı bileşenleri görüntülemek için etiket maskesi oluşturulur,
        # ardından etiket maskesindeki konturlar bulunur
